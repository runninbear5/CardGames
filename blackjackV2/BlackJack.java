...
public class BlackJack {
	public boolean playBlackJack() throws IOException {
		...
		ArrayList<CardNonImage> playerCards = new ArrayList<CardNonImage>();
		ArrayList<CardNonImage> dealerCards = new ArrayList<CardNonImage>();
	    ...
	    while(playersTurn){//checks to see if its the dealer turn
	       ...
	       for(CardNonImage card: playerCards) {
	    ...
	    while(dealersTurn) {//while dealer can still go
	    	...
	    	for(CardNonImage card: dealerCards) {
