...
public class CardNonImage {
     ...
     */
    public CardNonImage(String suit, int faceValue, BufferedImage card, boolean inDeck, boolean inHand, boolean inPlay) { //builds the card passing in value slots
    ...
    public CardNonImage(String suit, int faceValue, boolean inDeck, boolean inHand, boolean inPlay) { //builds the card passing in value slots
    ...
    public CardNonImage(String suit, int faceValue, boolean inDeck, boolean inHand, boolean inPlay, String fileName) { //builds the card passing in value slots
    ...
    public CardNonImage[] getRandomCards(int numOfCards) {
        Deck deck = new Deck();
        CardNonImage[] decks = deck.getCards(2);
        return decks;
        
    }
    public CardNonImage getRandomCard() {
        Deck deck = new Deck();
        return deck.getCard();
    }
