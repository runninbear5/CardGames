...
public class GameChoser {
	public static void main(String[] args) throws IOException {
		...
		boolean cont = true;
		while (play) {
			System.out.println("Welcome to game center, would you like to play: 'BlackJack', or 'quit'");
			...
			}else if (gameChoice.equals(quit)) {// checks if equal to blackjack to then play blackjack
					play=false;
			}
		}
	}
